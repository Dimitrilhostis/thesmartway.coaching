  ...
  return (
    <div className="min-h-screen flex items-center justify-center text-cream px-4 py-8 md:px-6 md:py-0">
      ...
      <div className="w-full max-w-5xl grid lg:grid-cols-[0.9fr_1.1fr] gap-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  <p className="text-xs uppercase tracking-wider text-dim mb-1">Téléphone</p>
                  <p className="text-base text-cream font-medium">07 68 70 43 64</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <p className="text-xs uppercase tracking-wider text-dim mb-1">Email</p>
        ...
        {/* RIGHT - FORM */}
        <div className="rounded-[28px] border border-border bg-forest-light/40 p-6 md:p-7">
